(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("teamscloud", [], factory);
	else if(typeof exports === 'object')
		exports["teamscloud"] = factory();
	else
		root["teamscloud"] = factory();
})(this, function() {
...
/* harmony import */ var _Constants__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Constants */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/Constants.js");
/* harmony import */ var _CustomAuthenticationProvider__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./CustomAuthenticationProvider */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/CustomAuthenticationProvider.js");
/* harmony import */ var _GraphRequest__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GraphRequest */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphRequest.js");
/* harmony import */ var _HTTPClient__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./HTTPClient */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/HTTPClient.js");
/* harmony import */ var _HTTPClientFactory__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./HTTPClientFactory */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/HTTPClientFactory.js");
/* harmony import */ var _ValidatePolyFilling__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ValidatePolyFilling */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/ValidatePolyFilling.js");
/**
 * -------------------------------------------------------------------------------------------
...
class Client {
    ...
    constructor(clientOptions) {
        ...
        if (clientOptions.authProvider !== undefined && clientOptions.middleware !== undefined) {
            ...
            httpClient = new _HTTPClient__WEBPACK_IMPORTED_MODULE_3__["HTTPClient"](clientOptions.middleware);
        }
        else {
            const error = new Error();
...
/*!****************************************************************************!*\
  !*** ./node_modules/@microsoft/microsoft-graph-client/lib/es/Constants.js ***!
  \****************************************************************************/
/*! exports provided: GRAPH_API_VERSION, GRAPH_BASE_URL */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _GraphError__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GraphError */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphError.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
class GraphErrorHandler {
    ...
    static constructError(error, statusCode) {
        const gError = new _GraphError__WEBPACK_IMPORTED_MODULE_1__["GraphError"](statusCode);
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _GraphErrorHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./GraphErrorHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphErrorHandler.js");
/* harmony import */ var _GraphRequestUtil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./GraphRequestUtil */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphRequestUtil.js");
/* harmony import */ var _GraphResponseHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./GraphResponseHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphResponseHandler.js");
/* harmony import */ var _middleware_MiddlewareControl__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./middleware/MiddlewareControl */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareControl.js");
/* harmony import */ var _RequestMethod__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./RequestMethod */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/RequestMethod.js");
/* harmony import */ var _ResponseType__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ResponseType */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/ResponseType.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
        ...
        this.parsePath = (path) => {
            ...
            if (queryStrPos === -1) {
                ...
                for (const queryParam of queryParams) {
                    ...
                    if (_GraphRequestUtil__WEBPACK_IMPORTED_MODULE_2__["oDataQueryNames"].indexOf(key) !== -1) {
...
/*!***********************************************************************************!*\
  !*** ./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphRequestUtil.js ***!
  \***********************************************************************************/
/*! exports provided: oDataQueryNames, urlJoin, serializeContent */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _ResponseType__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ResponseType */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/ResponseType.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "HTTPClientFactory", function() { return HTTPClientFactory; });
/* harmony import */ var _HTTPClient__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./HTTPClient */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/HTTPClient.js");
/* harmony import */ var _middleware_AuthenticationHandler__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./middleware/AuthenticationHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/AuthenticationHandler.js");
/* harmony import */ var _middleware_HTTPMessageHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./middleware/HTTPMessageHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/HTTPMessageHandler.js");
/* harmony import */ var _middleware_options_RedirectHandlerOptions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./middleware/options/RedirectHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/RedirectHandlerOptions.js");
/* harmony import */ var _middleware_options_RetryHandlerOptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./middleware/options/RetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/RetryHandlerOptions.js");
/* harmony import */ var _middleware_RedirectHandler__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./middleware/RedirectHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/RedirectHandler.js");
/* harmony import */ var _middleware_RetryHandler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./middleware/RetryHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/RetryHandler.js");
/* harmony import */ var _middleware_TelemetryHandler__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./middleware/TelemetryHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/TelemetryHandler.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _RequestMethod__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../RequestMethod */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/RequestMethod.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
/*!************************************************************************!*\
  !*** ./node_modules/@microsoft/microsoft-graph-client/lib/es/index.js ***!
  \************************************************************************/
/*! exports provided: BatchRequestContent, BatchResponseContent, AuthenticationHandler, HTTPMessageHandler, RetryHandler, RedirectHandler, TelemetryHandler, AuthenticationHandlerOptions, RetryHandlerOptions, RedirectHandlerOptions, FeatureUsageFlag, TelemetryHandlerOptions, LargeFileUploadTask, OneDriveLargeFileUploadTask, PageIterator, Client, GraphError, GraphRequest, ResponseType */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _content_BatchRequestContent__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./content/BatchRequestContent */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/content/BatchRequestContent.js");
...
/* harmony import */ var _content_BatchResponseContent__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./content/BatchResponseContent */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/content/BatchResponseContent.js");
...
/* harmony import */ var _middleware_AuthenticationHandler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./middleware/AuthenticationHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/AuthenticationHandler.js");
...
/* harmony import */ var _middleware_HTTPMessageHandler__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./middleware/HTTPMessageHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/HTTPMessageHandler.js");
...
/* harmony import */ var _middleware_RetryHandler__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./middleware/RetryHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/RetryHandler.js");
...
/* harmony import */ var _middleware_TelemetryHandler__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./middleware/TelemetryHandler */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/TelemetryHandler.js");
...
/* harmony import */ var _middleware_options_AuthenticationHandlerOptions__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./middleware/options/AuthenticationHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/AuthenticationHandlerOptions.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "AuthenticationHandlerOptions", function() { return _middleware_options_AuthenticationHandlerOptions__WEBPACK_IMPORTED_MODULE_7__["AuthenticationHandlerOptions"]; });

/* harmony import */ var _middleware_options_RetryHandlerOptions__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./middleware/options/RetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/RetryHandlerOptions.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RetryHandlerOptions", function() { return _middleware_options_RetryHandlerOptions__WEBPACK_IMPORTED_MODULE_8__["RetryHandlerOptions"]; });

/* harmony import */ var _middleware_options_RedirectHandlerOptions__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./middleware/options/RedirectHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/RedirectHandlerOptions.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "RedirectHandlerOptions", function() { return _middleware_options_RedirectHandlerOptions__WEBPACK_IMPORTED_MODULE_9__["RedirectHandlerOptions"]; });

/* harmony import */ var _middleware_options_TelemetryHandlerOptions__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./middleware/options/TelemetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/TelemetryHandlerOptions.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FeatureUsageFlag", function() { return _middleware_options_TelemetryHandlerOptions__WEBPACK_IMPORTED_MODULE_10__["FeatureUsageFlag"]; });

/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "TelemetryHandlerOptions", function() { return _middleware_options_TelemetryHandlerOptions__WEBPACK_IMPORTED_MODULE_10__["TelemetryHandlerOptions"]; });

/* harmony import */ var _tasks_LargeFileUploadTask__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./tasks/LargeFileUploadTask */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/tasks/LargeFileUploadTask.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "LargeFileUploadTask", function() { return _tasks_LargeFileUploadTask__WEBPACK_IMPORTED_MODULE_11__["LargeFileUploadTask"]; });

/* harmony import */ var _tasks_OneDriveLargeFileUploadTask__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./tasks/OneDriveLargeFileUploadTask */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/tasks/OneDriveLargeFileUploadTask.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "OneDriveLargeFileUploadTask", function() { return _tasks_OneDriveLargeFileUploadTask__WEBPACK_IMPORTED_MODULE_12__["OneDriveLargeFileUploadTask"]; });

/* harmony import */ var _tasks_PageIterator__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./tasks/PageIterator */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/tasks/PageIterator.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "PageIterator", function() { return _tasks_PageIterator__WEBPACK_IMPORTED_MODULE_13__["PageIterator"]; });

/* harmony import */ var _Client__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./Client */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/Client.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "Client", function() { return _Client__WEBPACK_IMPORTED_MODULE_14__["Client"]; });

/* harmony import */ var _GraphError__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./GraphError */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphError.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GraphError", function() { return _GraphError__WEBPACK_IMPORTED_MODULE_15__["GraphError"]; });

/* harmony import */ var _GraphRequest__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./GraphRequest */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/GraphRequest.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "GraphRequest", function() { return _GraphRequest__WEBPACK_IMPORTED_MODULE_16__["GraphRequest"]; });

/* harmony import */ var _ResponseType__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./ResponseType */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/ResponseType.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ResponseType", function() { return _ResponseType__WEBPACK_IMPORTED_MODULE_17__["ResponseType"]; });
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _MiddlewareControl__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./MiddlewareControl */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareControl.js");
/* harmony import */ var _MiddlewareUtil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MiddlewareUtil */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareUtil.js");
/* harmony import */ var _options_AuthenticationHandlerOptions__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./options/AuthenticationHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/AuthenticationHandlerOptions.js");
/* harmony import */ var _options_TelemetryHandlerOptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./options/TelemetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/TelemetryHandlerOptions.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _RequestMethod__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../RequestMethod */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/RequestMethod.js");
/* harmony import */ var _MiddlewareControl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MiddlewareControl */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareControl.js");
/* harmony import */ var _MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MiddlewareUtil */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareUtil.js");
/* harmony import */ var _options_RedirectHandlerOptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./options/RedirectHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/RedirectHandlerOptions.js");
/* harmony import */ var _options_TelemetryHandlerOptions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./options/TelemetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/TelemetryHandlerOptions.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
                ...
                if (redirectCount < options.maxRedirects && this.isRedirect(response) && this.hasLocationHeader(response) && options.shouldRedirect(response)) {
                    ...
                    if (response.status === RedirectHandler.STATUS_CODE_SEE_OTHER) {
                        ...
                        if (!this.isRelativeURL(redirectUrl) && this.shouldDropAuthorizationHeader(response.url, redirectUrl)) {
                            Object(_MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__["setRequestHeader"])(context.request, context.options, RedirectHandler.AUTHORIZATION_HEADER, undefined);
                        }
...
/* harmony import */ var _MiddlewareControl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MiddlewareControl */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareControl.js");
/* harmony import */ var _MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MiddlewareUtil */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareUtil.js");
/* harmony import */ var _options_RetryHandlerOptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./options/RetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/RetryHandlerOptions.js");
/* harmony import */ var _options_TelemetryHandlerOptions__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./options/TelemetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/TelemetryHandlerOptions.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _Version__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Version */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/Version.js");
/* harmony import */ var _MiddlewareControl__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./MiddlewareControl */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareControl.js");
/* harmony import */ var _MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./MiddlewareUtil */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareUtil.js");
/* harmony import */ var _options_TelemetryHandlerOptions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./options/TelemetryHandlerOptions */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/options/TelemetryHandlerOptions.js");
/**
...
class TelemetryHandler {
    ...
    execute(context) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            try {
                let clientRequestId = Object(_MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__["getRequestHeader"])(context.request, context.options, TelemetryHandler.CLIENT_REQUEST_ID_HEADER);
                if (clientRequestId === null) {
                    clientRequestId = Object(_MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__["generateUUID"])();
                    Object(_MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__["setRequestHeader"])(context.request, context.options, TelemetryHandler.CLIENT_REQUEST_ID_HEADER, clientRequestId);
                }
                ...
                Object(_MiddlewareUtil__WEBPACK_IMPORTED_MODULE_3__["appendRequestHeader"])(context.request, context.options, TelemetryHandler.SDK_VERSION_HEADER, sdkVersionValue);
                return yield this.nextMiddleware.execute(context);
            }
            catch (error) {
                throw error;
...
/* harmony import */ var _MiddlewareControl__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../MiddlewareControl */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/middleware/MiddlewareControl.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _Range__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../Range */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/Range.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _LargeFileUploadTask__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./LargeFileUploadTask */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/tasks/LargeFileUploadTask.js");
/* harmony import */ var _OneDriveLargeFileUploadTaskUtil__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./OneDriveLargeFileUploadTaskUtil */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/tasks/OneDriveLargeFileUploadTaskUtil.js");
/**
 * -------------------------------------------------------------------------------------------
 * Copyright (c) Microsoft Corporation.  All Rights Reserved.  Licensed under the MIT License.
 * See License in the project root for license information.
...
Object.defineProperty(exports, "__esModule", { value: true });
exports.Auth = void 0;
const microsoftTeams = __importStar(__webpack_require__(/*! @microsoft/teams-js */ "./node_modules/@microsoft/teams-js/dist/MicrosoftTeams.min.js"));
const microsoft_graph_client_1 = __webpack_require__(/*! @microsoft/microsoft-graph-client */ "./node_modules/@microsoft/microsoft-graph-client/lib/es/index.js");
const userInfo_1 = __webpack_require__(/*! ./models/userInfo */ "./src/models/userInfo.ts");
const utils_1 = __webpack_require__(/*! ./utils */ "./src/utils.ts");
class Auth {
    constructor(ssoToken) {
        this.ssoToken = ssoToken;
        this.tokenInfo = utils_1.Utils.parseJwt(ssoToken);
        this.userInfo = new userInfo_1.UserInfo(this.tokenInfo.name, this.tokenInfo.preferred_username);
    }
    static init() {
    ...
    static getMicrosoftGraphClient(accessToken) {
        return __awaiter(this, void 0, void 0, function* () {
            if (!Auth._authClient.graphClient) {
                if (!accessToken) {
                    var tokenResult = yield this.getGraphAccessToken();
                    accessToken = tokenResult.accessToken;
                }
                Auth._authClient.graphClient = microsoft_graph_client_1.Client.init({
                    defaultVersion: "v1.0",
                    debugLogging: true,
                    authProvider: (done) => {
                        if (accessToken) {
...
Object.defineProperty(exports, "__esModule", { value: true });
__exportStar(__webpack_require__(/*! ./auth */ "./src/auth.ts"), exports);
...
class UserInfo {
    constructor(userName, preferredUserName) {
...
//# sourceMappingURL=teamscloud.min.js.map